...
function buildIotaPrompt(mods) {
  return [
    ...
    '7. **No line numbers in documentation**: NEVER write specific code line numbers into the document. Line numbers rot immediately. Instead, describe code behavior and principles: explain what a function/event/module does, what input it consumes, what output it produces. Reference source file paths when needed for traceability, but always describe the mechanism, not the coordinate.',
    '',
    '## Priority Execution',
