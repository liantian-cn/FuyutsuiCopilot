...
| 辅助函数 | 返回 |
|----------|------|
| `get_lowest_health_unit(state_dict, health_threshold)` | `(slot, pct)` 或 `(None, None)` |
...
| `get_lowest_health_unit_with_any_aura(state_dict, *aura_names, health_threshold)` | `(slot, pct)` 或 `(None, None)` |
| `get_lowest_health_unit_without_aura(state_dict, aura_name, health_threshold)` | `(slot, pct)` 或 `(None, None)` |
| `get_lowest_health_unit_with_aura(state_dict, aura_name, health_threshold)` | `(slot, pct)` 或 `(None, None)` |
| `get_lowest_health_unit_with_aura_count(state_dict, aura_name, aura_count, health_threshold)` | `(slot, pct)` 或 `(None, None)` |
